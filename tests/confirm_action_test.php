...
/**
 * File containing tests for a confirm action.
 *
...
/**
 * The confirm_action test class.
 *
 * @package    local_customization
 * @copyright  2020 David Ordonez <davidherzlos@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class confirm_action_testcase extends \advanced_testcase {

    /**
     * @test
     * @testdox It should confirm something
     */
    public function test_add_course_event_from_core_code() {
        $this->resetAfterTest();
        $expected = true;
        $actual = true;
        $this->assertTrue($expected, $actual, 'It should confirm soemthing');
    }
}
